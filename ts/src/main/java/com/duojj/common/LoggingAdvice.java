...
public class LoggingAdvice {
	...
	@Before("execution(* com.duojj.service.*.*(..)) or " + "execution(* com.duojj.dao.*.*(..))")
	...
	@After("execution(* com.duojj.service.*.*(..)) or " + "execution(* com.duojj.dao.*.*(..))")
	...
	@Around("execution(* com.duojj.service.*.*(..)) or " + "execution(* com.duojj.dao.*.*(..))")
