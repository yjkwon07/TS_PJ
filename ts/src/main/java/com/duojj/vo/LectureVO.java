...
public class LectureVO {
	...
	private String	class_TUE;
	private String	class_WED;
	private String	class_THU;
	private String	class_FRI;
	...
	public void setClass_summary(String class_summary) {
		this.class_summary = class_summary;
	}
	...
	public String getClass_MON() {
		return class_MON;
	}
	public void setClass_MON(String class_MON) {
		this.class_MON = class_MON;
	}
	public String getClass_TUE() {
		return class_TUE;
	}
	public void setClass_TUE(String class_TUE) {
		this.class_TUE = class_TUE;
	}
	public String getClass_WED() {
		return class_WED;
	}
	public void setClass_WED(String class_WED) {
		this.class_WED = class_WED;
	}
	public String getClass_THU() {
		return class_THU;
	}
	public void setClass_THU(String class_THU) {
		this.class_THU = class_THU;
	}
	public String getClass_FRI() {
		return class_FRI;
	}
	public void setClass_FRI(String class_FRI) {
		this.class_FRI = class_FRI;
	}
	...
	public String getClass_SUN() {
		return class_SUN;
	}
	public void setClass_SUN(String class_SUN) {
		this.class_SUN = class_SUN;
	}
	public Double getClass_lat() {
		return class_lat;
	}
